...
class Chat:
    ...
    def infer(
        ...
        new_params_infer_code = {key: value for key, value in params_infer_code.items() if key != 'prompt'}
        result = infer_code(self.pretrain_models, text, **new_params_infer_code, return_hidden=use_decoder)
